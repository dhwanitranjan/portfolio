...
const Home = () => {
  return (
    <div className='flex flex-col md:flex-row h-screen w-full pt-20 px-6 bg-gradient-to-b from-black via-black to-gray-800' name='home'>
            ...
            <div className='flex flex-col justify-center h-full'>
                ...
                <div>
                    <button className='group flex flex-row w-fit px-4 py-4 rounded-md text-white bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer'>
                        Portfolio
                        <span className='group-hover:rotate-90 duration-200'><RiArrowRightSLine  size={25}/></span>
                    </button>
                </div>
            </div>
        </div>
        <div className='min-h-340 w-96 mx-auto my-auto items-center sm:px-4 sm:pt-6'>
